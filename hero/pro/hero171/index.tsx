              ...
              <div className="border-muted2 mt-12 flex gap-14 border-t">
                <div className="mt-8">
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-4">
                    <div className="text-muted-2-foreground text-5xl font-medium">
                      97K
                    </div>
                    <div className="text-muted-2-foreground max-w-28 text-base font-light leading-tight">
                ...
                <div className="border-muted2 mt-8 border-l pl-12">
                  ...
                  <p className="text-muted-2-foreground mt-4 max-w-28 text-base font-light leading-tight">
                    Watch promo video
                  </p>
                </div>
              </div>
